  ...
  return (
    <div>
      <div className="grid grid-cols-12 h-screen w-screen sm:px-56">
          ...
          <div>
            ...
            <div className="mt-1 text-xl font-semibold pr-4">
              ...
              <div className="mt-5 px-3">
                <button className="hidden sm:block bg-[#1d9bf0] text-lg font-semibold py-2 px-4 w-full rounded-full">
                  Tweet
                </button>

                <button className="block sm:hidden bg-[#1d9bf0] text-lg font-semibold py-2 px-4 w-full rounded-full">
                  <BsTwitter />
                </button>
              </div>
            </div>
        ...
        <div className="hidden sm:col-span-3 col-span-3 p-5">
          {!user && (
